...
>
 ...
 <nav className="social">
    <ul>
        <li><a href="https://www.facebook.com/share/1C1sytuDCt/?mibextid=wwXIfr" target="_blank">Facebook  <i className="bi bi-facebook soc_icon" style={{color: "rgba(24, 119, 242)"}}></i></a></li>
      <li><a href="https://www.instagram.com/sastha_express?igsh=cHF0ZzlvYjhiMGhu&utm_source=qr" target="_blank">Instagram <i className="bi bi-instagram soc_icon" style={{color: "#E1306C"}}></i></a></li>
      <li><a href="https://www.youtube.com/channel/UCblaQsteYYb_3fplhOM1Shg" target="_blank">Youtube <i className="bi bi-youtube soc_icon" style={{color: "#FF0000"}}></i></a></li>

 <li><a 
  data-bs-toggle="modal"
  data-bs-target="#callModal"
  role="button">Call Us <i className="bi bi-phone" style={{color: "#333"}}></i></a>
